...
<dt><a href="#subscribeToGetTokenBalance">subscribeToGetTokenBalance(did, currencyCode, callback, api)</a> ⇒ <code>Object</code></dt>
<dd><p>Subscribe to get the detailed token balance for a given token for given did</p>
</dd>
...
<dt><a href="#subscribeToGetDetailedTokenBalance">subscribeToGetDetailedTokenBalance(did, currencyCode, callback, api)</a> ⇒ <code>Object</code></dt>
<dd><p>Subscribe to get the detailed token balance for a given token for given did</p>
</dd>
...
<a name="subscribeToGetTokenBalance"></a>

## subscribeToGetTokenBalance(did, currencyCode, callback, api) ⇒ <code>Object</code>
...
| did | <code>String</code> |  |  |
| currencyCode | <code>String</code> |  |  |
| callback | <code>function</code> |  | Cb function to execute with new token balance in Highest Form |
| api | <code>ApiPromise</code> | <code>false</code> |  |
...
<a name="subscribeToGetDetailedTokenBalance"></a>

## subscribeToGetDetailedTokenBalance(did, currencyCode, callback, api) ⇒ <code>Object</code>
Subscribe to get the detailed token balance for a given token for given did
